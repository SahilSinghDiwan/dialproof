...
from .commands import run_command, verify_command, render_command, selftest_command
...
@click.option("--allow", multiple=True, required=True, help="Allowed hosts (can be used multiple times)")
